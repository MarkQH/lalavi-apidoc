 ...
 *     }
 *
 * @apiParam (Body) {String} [name=defaultName] User full name
 * @apiParam (Body) {String{6..20}} [username=12] Username for login
 * @apiParam (Body) {String} [password=password] If not provided will be auto generated
 * @apiParam (Body) {String="User", "Admin", "Moderator"} [userGroup="Admin"] User group the user belongs to
...
/**
 *
 * @api {PUT} /api/account/:id upload picture
 * @apiName upload picture
 ...
 * @apiParam {File} Avder Upload avatar.
 * @apiParam {File} Word Upload contrack.
 *
 * @apiExample {curl} curl
...
/**
 *
 * @api {GET} /api/account/:id/:num Get an account
 ...
 *     console.error(error);
 *   }
 * @apiParam (Query string) {String} [name=defaultName] User full name
 * @apiParam (Query string) {String{6..20}} [username=12] Username for login
 * @apiParam (Query string) {String} [password=password] If not provided will be auto generated
 * @apiParam (Query string) {String="User", "Admin", "Moderator"} [userGroup="Admin"] User group the user belongs to
 * @apiParam (Path) {String} [id="1"] User id
 * @apiParam (Path) {String} [num="2"] User num
 * @apiError {Object} error Error response
 * @apiErrorExample {json} Error-Response:
 * HTTP/1.1 404 Notfound
 * {
